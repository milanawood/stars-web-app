...
const ComingSoon: React.FC = () => {
  return (
    <div className="bg-sky-500/100 relative z-20 w-full h-full 800:h-screen top-0 left-0 artifact--027693b5d0dc">
      <div className="flex items-center justify-center w-full h-full 800:h-screen">
        <div className="w-full p-8 800:p-[5vw]" style={{ color: 'rgb(255, 255, 230)' }}>
          <div className="w-full text-left">
            <h2 className="uppercase py-2 my-2 font-termina text-98 leading-76 800:text-[15vh] 800:leading-[80%] 1000:text-[16vh]">
