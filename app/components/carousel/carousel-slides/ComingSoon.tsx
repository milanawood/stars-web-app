  ...
  return (
    <div className="w-full h-full relative">
      <div className="absolute z-[14] overflow-visible items-center justify-center pointer-events-none select-none
                top-[52%] transform -translate-y-1/2 right-[-20%] w-[75%] 
      ...
      <div className="absolute z-[14] overflow-visible items-center justify-center pointer-events-none select-none
                top-[78%] transform -translate-y-3/4 right-[1%] w-[32%] 
                400:top-[77%] 400:w-[33%] 800:top-[80%] 800:right-[5%] 800:w-[28%]">
        <Image
      ...
      <div className="relative z-20 w-full h-full 800:h-screen top-0 left-0 flex items-center justify-center">
        <div className="w-full p-8 800:p-[5vw] text-fontwhite">
          <div className="w-full text-left">
            <h2 className="uppercase py-2 my-2 font-termina font-bold text-5xl leading-[76%] 800:text-[7vh] 800:leading-[80%] 1000:text-[8vh]">
