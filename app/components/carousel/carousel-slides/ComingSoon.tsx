  ...
  return (
    <div className="w-full relative h-mobile-screen 800:h-screen">
      <div className="absolute z-[14] overflow-visible items-center justify-center pointer-events-none select-none
                ...
                max-w-375:top-[73%] max-w-375:w-[60%] max-w-375:right-[15%]
      ...
      <div className="absolute z-[14] overflow-visible items-center justify-center pointer-events-none select-none
                top-[78%] -translate-y-3/4 right-[1%] w-[32%] 
                max-w-375:top-[38%] max-w-375:right-[10%] max-w-375:w-28%]
                800:top-[80%] 800:right-[5%] 800:w-[28%] 
                max-w-799:top-[76%] max-w-799:right-[55%] max-w-799:w-[25%]">
        <Image
      ...
      <div className="relative z-20 w-full h-full 800:h-screen top-0 left-0 flex items-center justify-center max-w-799:top-[-17%]">
        <div className="w-full p-8 800:p-[5vw] text-fontwhite max-w-799:text-xl ">
          <div className="w-full text-left">
            <h2 className="uppercase py-2 my-2 font-termina font-bold text-5xl leading-[76%] max-w-375:text-[7vh] 800:text-[7vh] 800:leading-[80%] 1000:text-[8vh] max-w-799:text-[10vh]">
              Burgers<br />Coming<br /><span className="text-stars">Soon</span><br />!!!
            </h2>
            <div className="flex justify-center w-full ">
              <p className="text-14 800:text-22 font-termina ">
                <button className="relative text-fontwhite bg-transparent border-none my-4 text-18 800:text-22 uppercase max-w-[260px] 
                800:max-w-[310px] block rounded-full no-underline">
                  <svg className=" w-full max-w-[280px] 800:max-w-[310px] h-auto" width="367" height="65" viewBox="0 0 367 65" fill="none">
                    ...
                    fill="#2683EB" stroke="#F0EAD6" strokeWidth="1.5"></path>
                  </svg>
