...
const MarqueeSlide: React.FC = () => {
  return (
    <div className="embla__slide js-height mt-[60px] 600:h-mobile-screen 800:mt-0 w-screen 1000:min-w-[66vh] 1000:max-w-[66vh]">
      <div className="w-full overflow-hidden h-full top-0 relative">
        ...
        <div className="w-full h-full top-0 absolute left-0 z-10 flex items-center justify-center select-none pointer-events-none">
          <div className="w-[80%] h-[80%] border-4 border-solid border-cyan-500 800:h-[90%] 600:h-[60%] 400:h-[60%]"></div>
        </div>
        <Marquee>
