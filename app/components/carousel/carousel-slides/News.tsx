...
const News: React.FC = () => {
  return (
    <div className="w-full h-mobile-screen 800:h-screen top-0">
      <Sticker className="800:top-[55%] 800:transform 800:-translate-y-[55%] 800:left-[5px] 800:w-[200px] 
      max-w-799:[top-3%] max-w-799:-translate-y-[0.5%] max-w-799:w-[150px] max-w-799:left-[1%] 
      max-w-375:top-[17%] max-w-375:left-[40%] max-w-375:w-[150px]">
        <Image
          src="/images/cap.png"
          alt="STARS® logo pink"
          width={1034}
      ...
      <Sticker className="800:top-[52%] 800:transform 800:-translate-y-[52%] 800:right-[6px] 800:w-[200px] 
      max-w-799:right-[8%] max-w-799:transform max-w-799:bottom-[11%] max-w-799:w-[180px]
      max-w-375:left-[1%]">
        <Image
      ...
      <div className="absolute select-none pointer-events-none h-full 
      800:top-[-23%] 800:transform 800:-translate-y-[23%] 800:left-[3%] 800:w-[94%] 800:block max-w-799:top-[12%] 
      max-w-799:transform max-w-799:-translate-y-[38%] max-w-799:left-[3%] max-w-799:w-[94%] max-w-799:block 
      max-w-375:top-[5%] max-w-375:left-[3%] max-w-375:w-[100%] max-w-375:block bg-transparent">
        ...
        <div className="flex items-center justify-center w-full h-full 800:h-screen">
          <div className="w-full p-8 800:p-8 text-white">
            <p className="text-14 800:text-22 font-termina">
              <a
                className="text-sky-100 text-18 800:text-22 relative uppercase max-w-[260px] 800:max-w-[310px] block rounded-full no-underline"
                href="/about"
              >
                <svg
      ...
      <div className="absolute select-none pointer-events-none h-full 
      max-w-375:bottom-[-4%]
      800:left-[1%] 800:right-[1%] 800:bottom-[-35%] 800:w-[98%] 
      max-w-799:left-[15%] max-w-799:bottom-[-30%] max-w-799:w-[80%] bg-transparent">
        <figure className="select-none pointer-events-none">
          <div className="w-full h-full absolute top-0 left-0">
            <Image
