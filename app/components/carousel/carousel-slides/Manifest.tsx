...
const Manifest: React.FC = () => {
  return (
    <div className="embla__slide h-screen w-screen min-w-[100vw] 800:min-w-[80vh] 800:max-w-[800px]">
      <div className="absolute inset-0 select-none pointer-events-none"></div>
      <div className="relative z-20 w-full h-full flex items-center justify-center bg-stars bg-opacity-50">
